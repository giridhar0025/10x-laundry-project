  ...
  return (
    ...
    <hr className="referral-hr"></hr>
        <div className="referral-div">
            <h3 className="referral-h3">Now Refer & Earn <span>&#8377;</span>500 for every referral*</h3>
            <p className="referral-p">*Terms and Conditions will be applied</p>
        </div>
        <div style={{backgroundImage: `url('/Assets/Footer.svg')`,  backgroundRepeat: "no-repeat", backgroundSize: "cover", top: '0px'}} className="footer-container">
