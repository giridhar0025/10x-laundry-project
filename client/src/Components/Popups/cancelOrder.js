...
const CancelOrder = (props) => {
  ...
  //  console.log(ProductDetailsArr)
    ...
    fetch(`http://localhost:3001/order/cancel/${props.orderdata.orderId}`, {
      method: "DELETE",
      headers: {
                ...
                <Modal.Body>
                    <div>
                     ...
                     ProductDetailsArr.map((item)=>{
                        ...
                        <div style={{fontWeight: 'bold', fontSize: '15px'}} className="order-view-subTotal">Sub Total: {props.orderdata.subTotal}</div>
